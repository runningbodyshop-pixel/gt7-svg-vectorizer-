...
# =========================================================
# GT7 / Forza-style Layered SVG Vectorizer V6
# Experimental Safe Line Suppression Edition
# =========================================================

st.set_page_config(
    page_title="GT7 / Forza-style Layered SVG Vectorizer V6",
    layout="wide",
)
...
st.title("GT7 / Forza-style Layered SVG Vectorizer V6")
st.caption("V6：線消し方式を比較検証できる実験版。細線限定マスク、Soft Blend、Telea/NS inpaint、Median置換を切り替えて確認できます。")
